...
```
URL: https://img.icons8.com/3d-fluency/50/<name>.png   (try 3D first)
URL: https://img.icons8.com/fluency/50/<name>.png       (2D fallback)
URL: https://img.icons8.com/3d-fluency/100/<name>.png   (try 3D first)
URL: https://img.icons8.com/fluency/100/<name>.png       (2D fallback)
```

> Rule: try **3d-fluency** first; if 404, use **fluency**.
> Save as:
...
|---|---|---|
| ZIP archive | `zip` | fluency |
| RAR archive | `rar` | fluency |
| TAR archive | `tar` | fluency |
| ISO image | `iso` | fluency |
| PDF document | `pdf` | **3d-fluency** |
| TXT file | `txt` | fluency |
| CSV / Spreadsheet | `csv` | fluency |
| Spreadsheet (alt) | `table` | **3d-fluency** |
| EXE executable | `exe` | fluency |
| DLL file | `dll` | fluency |
| CFG/INI config | `settings` | fluency |
| TTF font | `ttf` | fluency |
| OTF font | `otf` | fluency |
| Generic document | `document` | **3d-fluency** |
| Presentation | `presentation` | **3d-fluency** |
| Notepad | `notepad` | **3d-fluency** |
| Generic file | `file` | fluency |
| MP3 audio | `mp3` | fluency |
| WAV audio | `wav` | fluency |
| Music | `music` | **3d-fluency** |
| Music album | `music-album` | fluency |
| Video file | `video-file` | fluency |
| Image file | `image-file` | fluency |
| Code file | `code-file` | fluency |
| JSON | `json` | fluency |
| SQL / Database | `sql` | fluency |
| Database | `database` | **3d-fluency** |
| APK (Android) | `apk` | fluency |
| Logbook | `logbook` | fluency |
| Event log | `event-log` | fluency |
| Batch script | `bat` | **3d-fluency** |
| PowerShell | `powershell` | fluency |
...
| Move | `move` | fluency |
| Move up | `move-up` | fluency |
| Move down | `move-down` | fluency |
| Filter | `filter` | **3d-fluency** |
| Group by | `group-by` | fluency |
| Sorting | `sorting` | **3d-fluency** |
| Sort by | `sort-by` | fluency |
| Categorize | `categorize` | fluency |
| Tag | `tag` | fluency |
| Check | `check` | fluency |
...
| Icon | Download name | Style |
|---|---|---|
| View mode | `view` | **3d-fluency** |
| Thumbnails | `thumbnails` | 2d-fluency |
| Large icons | `large-icons` | 2d-fluency |
| Medium icons | `medium-icons` | 2d-fluency |
| Small icons | `small-icons` | 2d-fluency |
| List mode | `list` | 2d-fluency |
| Details mode | `details` | 2d-fluency |
...
| Icon | Download name | Style |
|---|---|---|
| Pause | `pause` | 2d-fluency |
| Resume | `resume` | **3d-fluency** |
| Resume button | `resume-button` | 2d-fluency |
| Stop | `stop` | 2d-fluency |
| Process | `process` | **3d-fluency** |
| Loading | `loading` | **3d-fluency** |
| Playlist / Queue | `playlist` | **3d-fluency** |
...
| Icon | Download name | Style |
|---|---|---|
| Toolbar | `toolbar` | 2d-fluency |
| Tab | `tab` | 2d-fluency |
| Favorites | `favorites` | 2d-fluency |
| Desktop | `desktop` | 2d-fluency |
| My Computer | `computer` | 2d-fluency |
| Full screen | `full-screen` | 2d-fluency |
...
| Icon | Download name | Style |
|---|---|---|
| Online | `online` | **3d-fluency** |
| Offline | `offline` | 2d-fluency |
| Do not disturb | `do-not-disturb` | 2d-fluency |
| High priority | `high-priority` | **3d-fluency** |
| Bell / Notification | `bell` | **3d-fluency** |
| Mute | `mute` | 2d-fluency |
| Low volume | `low-volume` | 2d-fluency |
| Medium volume | `medium-volume` | 2d-fluency |
| High volume | `high-volume` | 2d-fluency |
| Speaker | `speaker` | 2d-fluency |
...
|---|---|---|
| VPN | `vpn` | 2d-fluency |
| Firewall | `firewall` | **3d-fluency** |
| Shutdown | `shutdown` | **3d-fluency** |
| Sleep | `sleep` | **3d-fluency** |
| Sleep mode | `sleep-mode` | 2d-fluency |
...
| Icon | Download name | Style |
|---|---|---|
| Bold | `bold` | 2d-fluency |
| Italic | `italic` | 2d-fluency |
| Underline | `underline` | 2d-fluency |
| Strikethrough | `strikethrough` | 2d-fluency |
| Align left | `align-left` | 2d-fluency |
| Align center | `align-center` | 2d-fluency |
| Align right | `align-right` | 2d-fluency |
| Justify | `align-justify` | 2d-fluency |
| Numbered list | `numbered-list` | 2d-fluency |
| Find & Replace | `find-and-replace` | 2d-fluency |
...
| Icon | Download name | Style |
|---|---|---|
| Clipboard | `clipboard` | 2d-fluency |
| Copy | `copy` | 2d-fluency |
| Broken link | `broken-link` | 2d-fluency |
| Chain / Link | `chain` | 2d-fluency |
| Tags | `tags` | 2d-fluency |
